...
if (isset($_POST['submit'])) {
    ...
    $rail = $_POST['rail'];
    $trek = $_POST['trek'];
    $sql = "update book_form set id='$id',name='$name',email='$email',phone='$phone',address='$address',guests='$guests',arrivals='$arrivals',leaving='$leaving',bday='$bday',gender='$gender',rail='$rail',trek='$trek'
    where id=$id";
    $result = mysqli_query($con, $sql);
    if ($result) {
					  ...
					  <input type="text" placeholder="Place you want to visit" required />
						...
						<div class="column">
							<div class="input-box" class="col-md-2">
								...
								<input name="arrivals" placeholder="Enter Arrival date" type="text" id="date_picker1"
									size=9 required value=<?php echo $arrivals ?> />
							</div>
							<div class="input-box" class="col-md-2">
								<label>Leaving</label>
								<input name="leaving" placeholder="Enter Leaving date" type="text" id="date_picker2"
									size=9 required value=<?php echo $leaving ?> />
							</div>
						</div>
						...
						<div class="gender-box">
							...
							<div class="gender-option">
								<div class="gender">
									<input type="radio" id="check-male" name="gender" value="Male" checked <?php echo $gender ?> />
						...
						<div class="input-box address">
							...
							<div class="column">
								...
								<div class="select-box">
									...
									<select name="trek" value=<?php echo $trek ?>>
